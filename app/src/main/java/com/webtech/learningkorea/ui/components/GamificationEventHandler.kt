...
import com.webtech.learningkorea.gamification.GamificationEvent
 ...
 */
private fun getSourceDisplay(source: String, strings: com.webtech.learningkorea.ui.localization.AppStrings): String {
    return when {
