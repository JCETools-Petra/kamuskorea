package com.webtech.learningkorea.ui.localization
...
data class AppStrings(
    ...
    val quizHafalan: String,
    val videoHafalan: String,
    val quiz: String,
    val settings: String,
    val profile: String,
...
fun getStrings(languageCode: String): AppStrings {
    return when (languageCode) {
        "en" -> AppStrings(
            ...
            quizHafalan = "Vocabulary Quiz",
            videoHafalan = "Learning Videos",
            quiz = "Quiz",
            settings = "Settings",
            profile = "Profile",
            ...
            quizHafalan = "Quiz Hafalan",
            videoHafalan = "Video Hafalan",
            quiz = "Latihan",
            settings = "Pengaturan",
            profile = "Profil",
